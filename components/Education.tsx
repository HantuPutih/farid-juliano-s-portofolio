    ...
    <Section id="education" title="Education & Languages">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-8">
          <h3 className="text-xl font-semibold flex items-center gap-2 mb-6 text-slate-800">
          ...
          <div className="space-y-8">
            {PORTFOLIO_DATA.education.map((edu, index) => (
              <div key={index} className="relative pl-6 border-l-2 border-slate-200">
                ...
                <p className="text-sm text-slate-500 mb-2 font-mono">{edu.period}</p>
                {edu.details && (
                  <ul className="list-disc list-inside space-y-1 text-slate-600 text-sm mt-2">
